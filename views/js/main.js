...
function changePizzaSizes(size) {
  //开销太大，保存变量
  var containerLength = document.getElementsByClassName("randomPizzaContainer");
...
function updatePositions() {
  ...
  var phasesExt = document.documentElement.scrollTop / 1250;
  for (var i = 0; i < items.length; i++) {
    var phase = Math.sin(phasesExt + (i % 5));
